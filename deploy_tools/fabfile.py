...
REPO_URL = "https://github.com/timthe/superlists.git"
...
def _update_settings(source_folder, site_name):
    ...
    sed(settings_path, 'ALLOWED_HOSTS = .+$', 'ALLOWED_HOST = ["%s"]' % (site_name,))
    secret_key_file = source_folder + '/superlists/secret_key.py'
    if not exists(secret_key_file):
        chars = 'abcdefgadfadfzcvzcerqerbll;j,iuoiu245423534!#$%#)'
